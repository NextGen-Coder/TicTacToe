...
public class SinglePlayerActivity extends AppCompatActivity {
    ...
    private boolean isEmptyBox( int i, int j) {
        return ticTacToeBoard[i][j].getText().toString().equals( "");
    }
    ...
    private void playRobotMove() {
        int[] points = getRandomEmptySpaceInBoard();
    ...
    private int[] getRandomEmptySpaceInBoard() {
        while( true) {
