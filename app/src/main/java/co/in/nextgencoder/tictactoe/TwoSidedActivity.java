...
public class TwoSidedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_two_sided);
    ...
    private void afterDraw() {
        dialog.setContentView( R.layout.dialog_result_two_sided);
        ...
        TextView winnerNameTV1 = dialog.findViewById( R.id.winnerName1);
        Button playAgainBtn1 = dialog.findViewById( R.id.playAgainBtn1);

        String videoUrl = "android.resource://"+getPackageName()+"/"+R.raw.two_sided_draw;

        winnerNameTV.setText( "Match Draw");
        winnerNameTV1.setText( "Match Draw");

        Uri uri = Uri.parse( videoUrl);
        videoView.setVideoURI( uri);
        videoView.start();

        playAgainBtn.setOnClickListener( v -> dialog.dismiss());
        playAgainBtn1.setOnClickListener( v -> dialog.dismiss());
    ...
    private void afterWin() {
        ...
        if( turn.equals( "X")) {
            winnerNameTV.setText( R.string.won_message);
            winnerNameTV1.setText( R.string.lost_message);
        } else {
            winnerNameTV.setText( R.string.lost_message);
            winnerNameTV1.setText( R.string.won_message);
            videoUrl = "android.resource://"+getPackageName()+"/"+R.raw.result_win_reversed;
        }
        Uri uri = Uri.parse( videoUrl);
        videoView.setVideoURI( uri);
        videoView.start();
        ...
        playAgainBtn1.setOnClickListener( v -> {
            clearBoard();
            dialog.dismiss();
        });
